...
values ('$_REQUEST[N_doc]' ,'$_REQUEST[Estado_idEstado]','$_REQUEST[PROGRAMA_Ficha_carac]','$_REQUEST[INSTRUCTOR_Num_doc]', '$_REQUEST[Tip_doc]', '$_REQUEST[Nombres]', '$_REQUEST[Apellidos]'
...
if ($resultado){
	echo "<script>
                ...
                window.location= 'vistaPrincipalAprendiz.php?pg3=funcionesAprendices'
    </script>";}
 else{
 	echo "<script>
