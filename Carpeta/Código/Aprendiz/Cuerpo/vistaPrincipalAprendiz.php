...
background:linear-gradient(30deg, crimson,sienna, royalblue, indianred, purple);
  ...
  <a href="vistaPrincipal.php?pg=pgInicial">Inicio </a>
      ...
      <a href="">logo</a>
      <a href="vistaPrincipalInstructor.php?pg">Notas</a>
    <a href="vistaPrincipalFichas.php?pg">Solicitudes </a>
  <tr>
...
<div id="divContenedor">
    <div id="divMenu">
      <table class="normal" summary="Tabla genérica" width="100%" height="480" border="3" align="center">
        
      <td align="center"><a href="vistaPrincipalAprendiz.php?pg3=funcionesAprendices">DATOS BASICOS</a></td>
