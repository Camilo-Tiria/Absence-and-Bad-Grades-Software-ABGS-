...
function Header()
{
  ...
  $this->Image('../Imagenes/fondopdf.jpg', 0, 0, 610, 300  );
    ...
    $this->Cell(-1050,50,'RESULTADOS DE APRENDIZAJE DE INGLES ',0,0,'C',0);
    $this->Cell(710,80,'Trimestre: I',0,1,'C',0);
    // Salto de línea
    $this->Ln(-30);
...
$sql="SELECT Code_Res,Nom_Res from r_aprendizaje WHERE Area='Inglés' AND Trimestre='I'";
...
$pdf->SetTitle("Resultados Ingles I");
