...
<a href="vistaPrincipalAprendiz.php?pg3=funcionesAprendices" class="boton">VOLVER</a>
...
<body>
      ...
      <td colspan="2" align="center" bgcolor="GRAY" style="color:white">MODIFICAR APRENDIZ</td>
       ...
       <tr>
        ...
        <td><label  for="PROGRAMA_Ficha_carac"></label>
          <select required name="PROGRAMA_Ficha_carac"  readonly="readonly" disabled ="disabled"  id="PROGRAMA_Ficha_carac" size="0" style="width:318px" title="Ficha en la que se encuentra el aprendiz">
        ...
        <td><label for="Tip_doc"></label>
          <select title="Tip_doc" readonly="readonly" disabled ="disabled" required name="Tip_doc" id="Tip_doc" type="enum" size="0" style="width:318px">
            <option value="0">Seleccione</option>
    ...
    <tr>
      ...
      <td><label for="Estado_idEstado"></label>
        ...
        <select title="Estado_idEstado" required name="Estado_idEstado" id="Estado_idEstado" readonly="readonly" disabled ="disabled" style="width:316px">
          <option value="0">Seleccione</option>
          <?php
