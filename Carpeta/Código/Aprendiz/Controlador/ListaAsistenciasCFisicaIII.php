...
$sql="SELECT i. Cod_Inas, i. N_doc, i. Fecha_Inas,i. Observaciones,i. Area, i. Trimestre, i. Instruc_Tecnico, a. N_doc, a. Nombres, a. PROGRAMA_Ficha_carac,a. Correo_SENA  FROM inasistencia as i inner join  aprendiz as a on i. N_doc= a. N_doc and i. Area = 'C.Física'  and a. Correo_SENA = '$user' where a. N_doc = i. N_doc and  Trimestre = 'III'";
...
<head>
<title>REGISTROS C.FISICA</title>
...
<body><br><br>
<h1 style="margin-top: 30px;" align="center">REGISTROS ASISTENCIAS DE C.FÍSICA III</h1>
<div id="divContenido2">
<table id="tabla12" class="table" width="89%" border="2" align="center">
<thead style="color: white">
<th>Codigo</th><th>ID_Apre</th><th>Nom_Apre</th><th>Fecha</th><th>Ficha</th><th>Doc_Instructor</th><th>Observaciones</th><th>Área</th><th>Trimestre</th>
</thead>
<tbody>
  <?php
  ...
  <tr bgcolor="#CCCCCC"> 
        ...
        <td><?php  echo $inasistencia->Instruc_Tecnico?></td>
