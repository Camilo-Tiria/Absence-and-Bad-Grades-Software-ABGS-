...
<tbody>
  ...
  <tr bgcolor="#CCCCCC"></tr>
    ...
    <div class="card-body">
              <center><a href="BoletinCFisicaI.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row1{
                width:212px ;
                 height:150px ;
    ...
    <div class="card-body">
              <center><a href="BoletinCFisicaII.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row2{
                width:212px ;
                 height:150px ;
    ...
    <div class="card-body">
              <center><a href="BoletinCFisicaIII.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row3{
                width:212px ;
                 height:150px ;
    ...
    <div class="card-body">
              <center><a href="BoletinCFisicaIV.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row4{
                width:212px ;
                 height:150px ;
    ...
    <div class="card-body">
              <center><a href="BoletinCFisicaV.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row5{
                width:212px ;
                 height:150px ;
    ...
    <div class="card-body">
              <center><a href="BoletinCFisicaVI.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row6{
                width:212px ;
                 height:150px ;
    ...
    <div class="card-body">
              <center><a href="BoletinCFisicaVII.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>"class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row7{
                width:212px ;
                 height:150px ;
    ...
    <div class="card-body">
              <center><a href="BoletinCFisicaVIII.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row8{
                width:212px ;
                 height:150px ;
