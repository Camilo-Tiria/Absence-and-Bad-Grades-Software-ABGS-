...
$sql="SELECT a. N_doc, a. PROGRAMA_Ficha_carac, a. Nombres, a. Apellidos, p. Ficha_carac, p. Trimestres from aprendiz as a Inner join programa as p on a. PROGRAMA_Ficha_carac = p. Ficha_carac where p. Ficha_carac = $_REQUEST[PROGRAMA_Ficha_carac] "  ;
      ...
      <div class="col-md1">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="VistaTIngles8.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row1{
                width:215px ;
                 height:150px ;
      ...
      <div class="col-md2">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="VistaTFisica8.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row2{
                width:215px ;
                 height:150px ;
      ...
      <div class="col-md3">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="VistaTTecnico8.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row3{
                width:215px ;
                 height:150px ;
      ...
      <div class="col-md4">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="VistaTPromover8.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
  </tbody>
 <style type="text/css">
                .row4{
                width:215px ;
