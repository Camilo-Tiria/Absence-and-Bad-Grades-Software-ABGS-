...
function Header()
{
  ...
  $this->Image('../Imagenes/fondopdf.jpg', 0, 0, 610, 300  );
    ...
    $this->Cell(710,80,'Trimestre: V',0,1,'C',0);
    // Salto de línea
    $this->Ln(-30);
...
$sql="SELECT Code_Res,Nom_Res from r_aprendizaje WHERE Area='Técnico' AND Trimestre='V'";
...
$pdf->SetTitle("Resultados Tecnico V");
