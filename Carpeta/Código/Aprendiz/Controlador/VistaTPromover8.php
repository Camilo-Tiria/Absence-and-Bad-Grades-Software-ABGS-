...
<tbody>
  ...
  <tr bgcolor="#CCCCCC"></tr>
    ...
    <div class="card-body">
              <center><a href="BoletinPromoverI.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row1{
                width:212px ;
                 height:150px ;
    ...
    <div class="card-body">
              <center><a href="BoletinPromoverII.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row2{
                width:212px ;
                 height:150px ;
    ...
    <div class="card-body">
              <center><a href="BoletinPromoverIII.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row3{
                width:212px ;
                 height:150px ;
    ...
    <div class="card-body">
              <center><a href="BoletinPromoverIV.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row4{
                width:212px ;
                 height:150px ;
    ...
    <div class="card-body">
              <center><a href="BoletinPromoverV.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row5{
                width:212px ;
                 height:150px ;
    ...
    <div class="card-body">
              <center><a href="BoletinPromoverVI.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row6{
                width:212px ;
                 height:150px ;
    ...
    <div class="card-body">
              <center><a href="BoletinPromoverVII.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>"class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row7{
                width:212px ;
                 height:150px ;
    ...
    <div class="card-body">
              <center><a href="BoletinPromoverVIII.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row8{
                width:212px ;
                 height:150px ;
