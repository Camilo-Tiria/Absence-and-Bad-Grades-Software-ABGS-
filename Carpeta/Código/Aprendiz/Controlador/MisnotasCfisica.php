...
$sql="SELECT n. Cod_Nota,  n. R_APRENDIZAJE_Code_Res, n. Nota, n. N_doc , n. Area ,a. N_doc , a. Nombres, a. PROGRAMA_Ficha_carac, a. Correo_SENA ,r. Code_Res, r. Nom_Res FROM notas as n INNER JOIN aprendiz as a on n. N_doc= a. N_doc INNER JOIN r_aprendizaje as r on n. R_APRENDIZAJE_Code_Res = r. Code_Res and  n. Area = 'C.Física' and a. Correo_SENA = '$user' and a. N_doc = a. N_doc";
...
<title>NOTAS C.FÍSICA</title>
<meta charset="utf-8">
</head>

<body>
<h1 align="center" style="margin-top: -3px;">NOTAS DE C.FÍSICA</h1>
