...
<h1 style="margin-top: 20px; "align="center">REGISTROS DE ASISTENCIAS</h1>
...
<tbody>
  ...
  ?>
    ...
    <td align="center"><a href="AreasAsistencias.php?PROGRAMA_Ficha_carac=<?php echo $programa->PROGRAMA_Ficha_carac?>"><p class="fas fa-arrow fa-arrow-circle-right fa-1x"></p></a></td>
    </tr>
  <?php
  }
  ?>
