...
$sql="SELECT i. Cod_Inas, i. N_doc, i. Fecha_Inas,i. Observaciones,i. Area, i. Trimestre, i. Instruc_Tecnico, a. N_doc, a. Nombres, a. PROGRAMA_Ficha_carac,a. Correo_SENA  FROM inasistencia as i inner join  aprendiz as a on i. N_doc= a. N_doc and i. Area = 'Técnico'  and a. Correo_SENA = '$user' where a. N_doc = i. N_doc and  Trimestre = 'I'";
...
<body><br><br>
<h1 style="margin-top: 30px;" align="center">REGISTROS ASISTENCIAS DE TÉCNICO I</h1>
