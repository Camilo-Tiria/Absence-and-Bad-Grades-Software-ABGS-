...
function Header()
{
  ...
  $this->Image('../Imagenes/fondopdf.jpg', 0, 0, 610, 300  );
    ...
    $this->Cell(-1050,50,'RESULTADOS DE APRENDIZAJE DE TECNICO ',0,0,'C',0);
...
$sql="SELECT Code_Res,Nom_Res from r_aprendizaje WHERE Area='Técnico' AND Trimestre='VIII'";
...
$pdf->SetTitle("Resultados Tecnico VIII");
