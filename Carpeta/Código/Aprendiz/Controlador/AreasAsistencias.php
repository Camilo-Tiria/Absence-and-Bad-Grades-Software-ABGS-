...
$sql="SELECT a. N_doc, a. PROGRAMA_Ficha_carac, a. Nombres, a. Apellidos, p. Ficha_carac from aprendiz as a Inner join programa as p on a. PROGRAMA_Ficha_carac = p. Ficha_carac where a. PROGRAMA_Ficha_carac = $_REQUEST[PROGRAMA_Ficha_carac] and Trimestres='6'" ;
...
<body>
  ...
  <tr bgcolor="#CCCCCC">
     ...
     <div class="container">   
    <CENTER><h1>ELIGE UNA ÁREA</h1></CENTER>
    <div class="row1">       
      <div class="col-md1">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="frmAsistenciaArea1.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row1{
                width:215px ;
                 height:150px ;
      ...
      <div class="col-md2">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="frmAsistenciaArea2.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row2{
                width:215px ;
                 height:150px ;
      ...
      <div class="col-md3">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="frmAsistenciaArea3.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row3{
                width:215px ;
                 height:150px ;
      ...
      <div class="col-md4">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="frmAsistenciaArea4.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
    ...
    echo "<script>
                ...
                window.location= 'AsistenciasAreasT.php?PROGRAMA_Ficha_carac=$_REQUEST[PROGRAMA_Ficha_carac]'
    </script>";
