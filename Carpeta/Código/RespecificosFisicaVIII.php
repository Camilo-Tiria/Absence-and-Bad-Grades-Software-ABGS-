...
<table  id="tabla8" width="100%" class="table" border="2" align="center">
  <thead style="color: white;"> 
    <th>N_doc</th><th>Nombres</th><th>Apellidos</th><th>Ficha</th><th>Área</th><th>Reporte</th>
...
<tbody>
  ...
  <tr bgcolor="#CCCCCC">
        ...
        <td><?php  echo "C.Física" ?></td>
         ...
         <td align="center"><a href="RegistrosEFisicaVIII.php?N_doc=<?php echo $aprendiz->N_doc?>"><P class="fas fa-color fa-calendar-check fa-1x"><P>  </a></td>
