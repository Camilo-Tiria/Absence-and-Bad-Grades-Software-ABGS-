...
<html>
<head>
  <title>AREAS/CALIFICACIONES</title> 
  <meta charset="utf-8">
...
<body>
  ...
  <div class="container">   
      ...
      <div class="col-md1">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="registrosnotasArea1.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row1{
                width:215px ;
                 height:150px ;
      ...
      <div class="col-md2">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="registrosnotasArea2.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row2{
                width:215px ;
                 height:150px ;
      ...
      <div class="col-md3">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="registrosnotasArea3.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row3{
                width:215px ;
                 height:150px ;
      ...
      <div class="col-md4">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="registrosnotasArea4.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row4{
                width:215px ;
                 height:150px ;
   ...
   echo "<script>
                ...
                window.location= 'frmRegistrosNotaAreaT.php?Ficha_carac=$_REQUEST[Ficha_carac]'
    </script>";
  ...
  ?> 
<div id="divbutton1">
<button><a style="text-decoration: none;" href="vistaPrincipalAsistencia.php?pg2=calificacionesficha"  ><i class="fas fa-arrow-left fa-2x"></i></a></button>
</div>
<style type="text/css">
#divbutton1 {
  position:absolute;
