...
<h1 style="margin-top: 60px;" align="center">REGISTROS NOTAS DE INGLÉS II</h1>
    <div id="divContenido">
   ...
   <td><?php  echo $notas->Cod_Nota ?></td>
        ...
        <td><?php  echo $notas->PROGRAMA_Ficha_carac ?></td>
          <td><?php  echo $notas->Nom_Res ?></td>
           ...
           <td rowspan="1"><a style="text-decoration: none; " href='PDFNotasInglesII.php?PROGRAMA_Ficha_carac=<?php echo $notas->PROGRAMA_Ficha_carac?>'><p class="fas fa-colorpdf fa-download  "></p>Descargar PDF</a></td>
