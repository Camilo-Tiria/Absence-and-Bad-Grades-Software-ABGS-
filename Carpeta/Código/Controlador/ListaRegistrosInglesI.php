...
<h1 style="margin-top: 60px;" align="center">REGISTROS NOTAS DE INGLÉS I</h1>
    <div id="divContenido">
 ...
 while ($notas = $resultado1->fetch_object())
  ...
  <tr bgcolor="#CCCCCC">
        ...
        <td><?php  echo $notas->Nom_Res ?></td>
           ...
           <td rowspan="1"><a style="text-decoration: none; " href='PDFNotasInglesI.php?PROGRAMA_Ficha_carac=<?php echo $notas->PROGRAMA_Ficha_carac?>'><p class="fas fa-colorpdf fa-download  "></p>Descargar PDF</a></td>
