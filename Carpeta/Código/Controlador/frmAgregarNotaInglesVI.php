...
<body>
  <form style="margin-top: 90px;border-radius: 20px" id="form1" name="form1" method="post" action="AgregarNota.php">
        ...
        <center><td colspan="2" align="center" bgcolor="GRAY" style="color: white">✬AGREGAR NOTA INGLÉS✬</td></center></tr>
        ...
        <td><label for="Area"></label>
        <select title="Area" required name="Trimestre" id="Trimestre" type="enum" size="0" style="width:325px">
