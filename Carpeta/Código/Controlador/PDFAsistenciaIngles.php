...
function Header()
{
  ...
  $this->Image('../Imagenes/fondopdf.jpg', 0, 0, 610, 300  );
    ...
    $this->Cell(130,80,'REGISTRO DE ASISTENCIA AREA INGLES ',0,1,'C');
    // Salto de línea
    $this->Ln(-20);
...
$sql="SELECT  i. Cod_Inas, i. N_doc, i. Fecha_Inas, i. Observaciones,i. Area, a. N_doc, a. Nombres, a. PROGRAMA_Ficha_carac  FROM inasistencia as i inner join  aprendiz as a on i. N_doc= a. N_doc where Area = 'Inglés' and a. PROGRAMA_Ficha_carac = $_REQUEST[PROGRAMA_Ficha_carac]";
...
$pdf->SetTitle("PDF Asistencia Ingles");
