...
<h1 style="margin-top: 60px;" align="center">REGISTROS NOTAS PROMOVER V</h1>
    <div id="divContenido">
        ...
        <td><?php  echo $notas->Cod_Nota ?></td>
         ...
         <td><?php  echo $notas->Nombres ?></td>
          <td><?php  echo $notas->Nom_Res ?></td>
           ...
           <td rowspan="1"><a style="text-decoration: none; " href='PDFNotasEPromoverV.php?N_doc=<?php echo $notas->N_doc?>'><p class="fas fa-colorpdf fa-download  "></p>Descargar PDF</a></td>
