...
<h1 style="margin-top: 70px;" align="center">REGISTRAR ASISTENCIA TÉCNICO VI</h1>
...
<tbody>
  ...
  <tr bgcolor="#CCCCCC">
        ...
        <td><?php  echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VI" ?></td>
            ...
            <td align="center"><a href="frmAgregarInasistenciaTecnicoVI.php?N_doc=<?php echo $aprendiz->N_doc?>"><p class="fas fa-color fa-calendar-check fa-1x"></p>  </a></td>
