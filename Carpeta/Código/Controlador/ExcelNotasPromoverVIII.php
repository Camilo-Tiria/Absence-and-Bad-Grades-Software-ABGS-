...
$sql="SELECT n. Cod_Nota,n. Trimestre,  n. R_APRENDIZAJE_Code_Res, n. Nota, n. N_doc , n. Area , n. INSTRUCTOR_Num_doc, a. N_doc , a. Nombres,a. Apellidos, a. PROGRAMA_Ficha_carac, r. Code_Res, r. Nom_Res , i. Num_doc, i. NombresI FROM notas as n INNER JOIN aprendiz as a on n. N_doc= a. N_doc INNER JOIN r_aprendizaje as r on n. R_APRENDIZAJE_Code_Res = r. Code_Res INNER JOIN instructor as i on i. Num_doc = n. INSTRUCTOR_Num_doc and  n. Area = 'Promover' and a. PROGRAMA_Ficha_carac = $_REQUEST[PROGRAMA_Ficha_carac] and n. Trimestre = 'VIII'";

$resultado = $objConexion->query($sql);

header("Content-Type:   application/vnd.ms-excel; charset=utf-8");
header("Content-Disposition: attachment; filename=NotasPromoverVIII.xls");
?>
<table border="1" >
	<caption bgcolor="green">REGISTROS NOTAS DEL AREA PROMOVER VIII TRIMESTRE</caption>
	<tr>
