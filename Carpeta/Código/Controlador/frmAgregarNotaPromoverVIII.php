...
$sql1 = "select Nom_Res, Code_Res , Area from r_aprendizaje where Area = 'Promover' and Trimestre = 'VIII'";
$sql2 = "select Num_doc , NombresI, ApellidosI , Area from instructor WHERE Area= 'Promover'  ";
...
<body>
    <form style="margin-top: 90px"; id="form1" name="form1" method="post" action="AgregarNota.php">

        <center><td colspan="2" align="center" bgcolor="GRAY" style="color: white">✬AGREGAR NOTA PROMOVER✬</td></center>
      </tr>
        ...
        <select title="Instructor encargado/Técnico" required name="INSTRUCTOR_Num_doc" id="INSTRUCTOR_Num_doc" style="width:325px">
         ...
         <td align="right" bgcolor="#EAEAEA">N°_Aprendiz</td>
             ...
             <td><label for="N_doc"></label>
              <input title="N_doc" required name="N_doc" type="int" id="N_doc" value="<?php echo $N_doc;?>"size="40" /></td>
            </tr>
      ...
      <tr>
       ...
       <td><label for="R_APRENDIZAJE_Code_Res"></label>
          ...
          <select title="Estado del aprendiz" required name="R_APRENDIZAJE_Code_Res" id="R_APRENDIZAJE_Code_Res" style="width:325px">
     ...
     <td><label for="Area"></label>
        ...
        <td><label for="Nota">Nota</label>
          <select title="Tipo de documento del aprendiz" required name="Nota" id="Nota" type="enum" size="0" style="width:325px">
      ...
      <tr> <td align="right" bgcolor="#EAEAEA">Trimestre:</td>
