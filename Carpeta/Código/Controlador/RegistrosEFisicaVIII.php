...
<h1 style="margin-top: 60px;" align="center">REGISTROS NOTAS DE C.FÍSICA VIII</h1>
    <div id="divContenido">
        <table  id="tabla4" class="table" style="margin-top: -1px;" border="2" align="center">
   <thead style="color: white;">
     <th>Cod&nbsp;&nbsp;</th><th>ID&nbsp;&nbsp;</th><th>Ficha&nbsp;&nbsp;</th><th>Aprendiz&nbsp;&nbsp;</th><th>R_Aprendizaje</th><th>Instructor</th><th>Área&nbsp;&nbsp;</th><th>Nota&nbsp;&nbsp;</th><th>Trimestre&nbsp;&nbsp;</th><th>PDF</th><th>Eliminar&nbsp;</th>
   </thead>
   <tbody>
  <?php
  ...
  <tr bgcolor="#CCCCCC">
        <td><?php  echo $notas->Cod_Nota ?></td>
         ...
         <?php $color = $notas->Nota;
           ...
           <td rowspan="1"><a style="text-decoration: none; " href='PDFNotasEFisicaVIII.php?N_doc=<?php echo $notas->N_doc?>'><p class="fas fa-colorpdf fa-download  "></p>Descargar PDF</a></td>
