...
<h1 style="margin-top: 60px;" align="center">REGISTROS NOTAS DE C.FÍSICA II</h1>
    <div id="divContenido">
  ...
  <tr bgcolor="#CCCCCC">
        <td><?php  echo $notas->Cod_Nota ?></td>
         ...
         <?php $color = $notas->Nota;
           ...
           <td rowspan="1"><a style="text-decoration: none; " href='PDFNotasEFisicaII.php?N_doc=<?php echo $notas->N_doc?>'><p class="fas fa-colorpdf fa-download  "></p>Descargar PDF</a></td>
