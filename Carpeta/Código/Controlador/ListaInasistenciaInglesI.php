...
<tbody>
  ...
  <tr bgcolor="#CCCCCC">
        ...
        <td><?php  echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I" ?></td>
            ...
            <td align="center"><a href="frmAgregarInasistenciaInglesI.php?N_doc=<?php echo $aprendiz->N_doc?>"><p class="fas fa-color fa-calendar-check fa-1x"></p>  </a></td>
             <td align="center"><a href="frmAgregarInasistenciaInglesCon.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->PROGRAMA_Ficha_carac?>"><p class="fas fa-color fa-calendar-check fa-1x"></p>  </a></td>
