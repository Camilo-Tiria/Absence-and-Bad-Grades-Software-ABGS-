...
<tbody>
  ...
  <tr bgcolor="#CCCCCC">
      ...
      <div class="col-md1">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="ListaAsistenciasFisicaI.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row1{
                width:212px ;
                 height:150px ;
      ...
      <div class="col-md2">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="ListaAsistenciasFisicaII.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row2{
                width:212px ;
                 height:150px ;
      ...
      <div class="col-md3">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="ListaAsistenciasFisicaIII.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row3{
                width:212px ;
                 height:150px ;
      ...
      <div class="col-md3">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="ListaAsistenciasFisicaIV.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row4{
                width:212px ;
                 height:150px ;
      ...
      <div class="col-md3">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="ListaAsistenciasFisicaV.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row5{
                width:212px ;
                 height:150px ;
      ...
      <div class="col-md3">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="ListaAsistenciasFisicaVI.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row6{
                width:212px ;
                 height:150px ;
    ...
    echo "<script>
                ...
                window.location= 'listaAsistenciaAreaT2.php?Ficha_carac=$_REQUEST[PROGRAMA_Ficha_carac]'
    </script>";
