...
<body>
  ...
  <div class="container">   
      ...
      <div class="col-md1">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="listaAsistenciaArea1.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row1{
                width:215px ;
                 height:150px ;
      ...
      <div class="col-md2">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="listaAsistenciaArea2.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row2{
                width:215px ;
                 height:150px ;
      ...
      <div class="col-md3">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="listaAsistenciaArea3.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
              <style type="text/css">
                .row3{
                width:215px ;
                 height:150px ;
      ...
      <div class="col-md4">        
          <div class="card">
            ...
            <div class="card-body">
              ...
              <center><a href="listaAsistenciaArea4.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center>
    ...
    echo "<script>
                ...
                window.location= 'listaAsistenciaAreaT.php?Ficha_carac=$_REQUEST[Ficha_carac]'
    </script>";
