...
$sql2 ="select Ficha_carac from programa where Estado= 'Activo' ";
...
<body><br>
  <form  style="margin-top: -11px;border-radius: 20px;margin-left: 280px"id="form1" name="form1" method="post" action="Agregar.php">
      <center><td colspan="2" align="center" bgcolor="GRAY" style="color:white" >✬AGREGAR APRENDIZ✬</td></center>
        ...
        <input type="int" required="" name="N_doc" maxlength="10" autocomplete="off" value="<?php if(isset($N_doc)) echo $N_doc ?>">
        ...
        <input title="Nombres del aprendiz" maxlength="25" required name="Nombres" autocomplete="off" type="text" id="Nombres" size="40" /></td></tr><tr>

        <label for="">Apellidos:</label>
        <input title="Apellidos del aprendiz" maxlength="30" required name="Apellidos" autocomplete="off" type="text" id="Apellidos" size="40" /></td></tr><tr>

        <label for="">Teléfono:</label>
        <input title="Teléfono del aprendiz" maxlength="10" required name="Tel_apre" autocomplete="off" type="int" id="Tel_apre" size="40" /></td></tr>

        <label for="">Correo_SENA:</label>
        <input value='@misena.edu.co' title="Correo SENA del aprendiz" required name="Correo_SENA" type="email" id="Correo_SENA" size="40"placeholder="PaezT@misena.edu.co" pattern="[A-Za-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{3,}+\.[a-z]{2,}$"           /></td></tr><tr>

        <label for="">Correo_Pl:</label>
        <input value='@gmail.com' title="Correo personal del aprendiz" required name="Correo_Pl" type="email" id="Correo_Pl" size="40" placeholder="Adrian09@gmail.com" pattern="[A-Za-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{3,}+\.[a-z]{2,}$  
        "/></td></td></tr><tr><tr>
