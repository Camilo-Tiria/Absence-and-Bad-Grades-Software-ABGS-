...
$sql="SELECT r. Code_Res,r. Area,r. Trimestre, r. Nom_Res  FROM r_aprendizaje as r WHERE  r. Area= 'Inglés'";
...
<head>
  ...
  <title>R_APRENDIZAJE/INGLÉS</title>
...
<h1 style="margin-top: 60px;" align="center">R_APRENDIZAJES INGLÉS</h1>
    <div id="divContenido">
...
while ($r_aprendizaje= $resultado->fetch_object())
  ...
  <tr bgcolor="#CCCCCC">
      ...
      <td align="center"><a href="EditarR_AIngles.php?Code_Res=<?php echo $r_aprendizaje->Code_Res?>"><p class="fas fa-color fa-cogs"></p></a></td>
    ...
    <td align="center"><a href="frmAgregarR_AIngles.php"><p class="fas fa-color fa-cogs"></p>
    </tr>
