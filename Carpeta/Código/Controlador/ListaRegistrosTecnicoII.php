...
<h1 style="margin-top: 60px;" align="center">REGISTROS NOTAS DE TÉCNICO II</h1>
    <div id="divContenido">
  ...
  <tr bgcolor="#CCCCCC">
      ...
      case '10' : $color1 = 'rgb(235, 143, 143)' ; break;
            ...
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php  echo $notas->Trimestre ?></td>
             <td rowspan="1"><a style="text-decoration: none; " href='PDFNotasTecnicoII.php?PROGRAMA_Ficha_carac=<?php echo $notas->PROGRAMA_Ficha_carac?>'><p class="fas fa-colorpdf fa-download  "></p>Descargar PDF</a></td>
