...
$sql="SELECT  i. Cod_Inas, i. N_doc, i. Fecha_Inas, i. Observaciones,i. Area,i. Trimestre,  a. N_doc, a. Nombres, a. PROGRAMA_Ficha_carac  FROM inasistencia as i inner join  aprendiz as a on i. N_doc= a. N_doc where Area = 'Promover' and a.PROGRAMA_Ficha_carac = $_REQUEST[PROGRAMA_Ficha_carac] and i. Trimestre = 'IV'";
...
<body>
  <br>
  <br>
   <h1 style="margin-top: 30px;" align="center">REGISTROS PROMOVER IV</h1>
