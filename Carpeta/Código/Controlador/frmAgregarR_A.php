...
<head><body background= "../Imagenes/FOL11.jpg" style="background-repeat: no-repeat; background-position: absolute;background-size: cover">
</body>
...
<body>
  <form style="margin-top: 70px" id="form1" name="form1" method="post" action="AgregarR_A.php">
    ...
    <center><td colspan="2" align="center" bgcolor="GRAY" style="color: white">✬AGREGAR R_APRENDIZAJE✬</td></center></tr><tr bgcolor="red">

    <td align="right" bgcolor="red">Área:</td>
    ...
    <input title="Nom_Res" required name="Nom_Res" maxlength="124" type="text" id="Nom_Res" size="0" style="width:325px" /></td></tr><tr><br></td><tr>
