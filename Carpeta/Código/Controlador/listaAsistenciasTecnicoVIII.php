...
$sql="SELECT  i. Cod_Inas, i. N_doc, i. Fecha_Inas, i. Observaciones,i. Area, a. N_doc, a. Nombres,i. Trimestre, a. PROGRAMA_Ficha_carac  FROM inasistencia as i inner join  aprendiz as a on i. N_doc= a. N_doc where Area = 'Técnico' and a.PROGRAMA_Ficha_carac = $_REQUEST[PROGRAMA_Ficha_carac]  and i. Trimestre = 'VIII'";
