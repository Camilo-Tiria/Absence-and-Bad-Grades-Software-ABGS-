...
function Header()
{
  ...
  $this->Image('../Imagenes/fondopdf.jpg', 0, 0, 610, 300  );
    ...
    $this->Cell(130,80,'REGISTRO DE NOTAS AREA PROMOVER ',0,0,'C');
        $this->Cell(-336,110,'TRIMESTRE: III ',0,1,'C');
...
$sql="SELECT n. Cod_Nota,n. Trimestre,  n. R_APRENDIZAJE_Code_Res, n. Nota, n. N_doc , n. Area ,a. N_doc , a. Nombres, a. PROGRAMA_Ficha_carac, r. Code_Res, r. Nom_Res ,r. INSTRUCTOR_Num_doc, i. Num_doc, i. NombresI FROM notas as n INNER JOIN aprendiz as a on n. N_doc= a. N_doc INNER JOIN r_aprendizaje as r on n. R_APRENDIZAJE_Code_Res = r. Code_Res INNER JOIN instructor as i on i. Num_doc = r. INSTRUCTOR_Num_doc and  n. Area = 'Promover' and n. Trimestre = 'III' and a. N_doc = $_REQUEST[N_doc]";
...
$pdf->SetTitle("PDF Notas Promover");
