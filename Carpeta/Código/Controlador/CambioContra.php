  ...
  <label for="">Contraseña Actual:</label>
       ...
       <label for="">Nueva Contraseña:</label>
             ...
             <td><label for="passnueva"></label>
              <input name="pass1" type="password" id="passnueva" size="40" minlength="8" maxlength="16" pattern="(?=.*\d)(?=.*[a-záéíóúüñ]).*[A-ZÁÉÍÓÚÜÑ].*"
              title="Debe tener al menos una mayúscula, una minúscula y un dígito" placeholder="**********"  /></td>
           ...
           <label for="">Repita contraseña:</label>
             ...
             <td><label for="pass2"></label>
              <input title="Nueva Contraseña"  name="pass2" type="password" id="pass2" maxlength= "30"size="40" /></td>
