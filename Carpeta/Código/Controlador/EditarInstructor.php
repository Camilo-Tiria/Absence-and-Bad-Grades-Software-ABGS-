...
<body>
     ...
     <form style="margin-top: 4%;;border-radius: 20px" id="form1" name="form1" method="post" action="ModificarInstructor.php">
...
<button  class="bto"><a style="text-decoration: none;" href="listarInstructores1.php"  ><p class="fas fa-arrow-left fa-2x"></p></a></button>
</div>
