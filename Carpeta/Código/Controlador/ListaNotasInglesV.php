...
<h1 style="margin-top: 60px;" align="center">REGISTRAR NOTAS DE INGLÉS V</h1>
...
<tbody>
  ...
  <tr bgcolor="#CCCCCC">
        ...
        <td><?php  echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;V" ?></td>
         <td align="center"><a href="frmAgregarNotaInglesV.php?N_doc=<?php echo $aprendiz->N_doc?>"><P class="fas fa-color fa-calendar-check fa-1x"><P>  </a></td>
