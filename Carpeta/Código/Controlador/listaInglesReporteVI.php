...
$sql="SELECT  i. Cod_Inas, i. N_doc, i. Fecha_Inas,i. Trimestre,  i. Observaciones,i. Area, a. N_doc, a. Nombres, a. PROGRAMA_Ficha_carac  FROM inasistencia as i inner join  aprendiz as a on i. N_doc= a. N_doc where Area = 'Inglés' and a. N_doc = $_REQUEST[N_doc]  and i. Trimestre = 'VI'";
  ...
  <tr bgcolor="#CCCCCC"> 
       <td><?php  echo $inasistencia->Cod_Inas ?></td>
        ...
        <?php $color = $inasistencia->Observaciones;
          ...
          <td rowspan="1"><a style="text-decoration: none; " href='PDFEspeInglesVI.php?N_doc=<?php echo $inasistencia->N_doc?>'><p class="fas fa-colorpdf fa-download  "></p>Descargar PDF</a></td>
