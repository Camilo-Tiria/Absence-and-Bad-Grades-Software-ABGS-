...
$sql1 = "select Nom_Res, Code_Res , Area , Trimestre from r_aprendizaje where Area = 'Inglés' and Trimestre = 'VIII' ";
...
<body>
  <form style="margin-top: 90px"; id="form1" name="form1" method="post" action="AgregarNota.php">
        ...
        <center><td colspan="2" align="center" bgcolor="GRAY" style="color: white">✬AGREGAR NOTA INGLÉS✬</td></center>
      </tr>
