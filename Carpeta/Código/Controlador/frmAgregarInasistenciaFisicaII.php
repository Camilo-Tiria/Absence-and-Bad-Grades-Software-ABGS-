...
<title>ASISTENCIA C.FÌSICA</title>
...
function mensaje(){
 swal({
   title: "AGREGADO",
   text: "La Asistencia se agregó correctamente",
   icon: 'success',
   timer: 6000,
...
<form style="margin-top: 90px;" id="form1" name="form1" method="post" action="AgregarInasistencia.php">

    <tr>
        <center><td colspan="2" align="center" bgcolor="GRAY" style="color:white">✬AGREGAR ASISTENCIA C.FÌSICA✬</td></center>
   <tr>
    <br>
           <tr>
            <tr>
    ...
    <input type="datetime" name="Fecha_Inas" step="1" min="2013-01-01T00:00Z" max="2013-12-31" value="<?php echo date("Y-m-d");?>">
...
<td align="right" bgcolor="#EAEAEA">Observaciones:</td>
     <td><label for="Observaciones"></label>
          <select title="Tipo de documento del aprendiz" required name="Observaciones" id="Observaciones" type="enum" size="0" style="width:325px">
...
<button class="bto"><a href='javascript:history.back()'class="fas fa-arrow-left fa-2x"></a></button>
          ...
          <td class="button" colspan="2" align="center" bgcolor="GRAY"><input type="submit" name="button" id="button" onclick="mensaje()" value="Enviar" /></td>
        </tr>
    </table>
