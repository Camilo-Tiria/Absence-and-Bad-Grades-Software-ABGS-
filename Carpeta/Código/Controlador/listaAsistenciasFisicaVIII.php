...
$sql="SELECT  i. Cod_Inas, i. N_doc, i. Fecha_Inas, i. Observaciones,i. Area,i. Trimestre, a. N_doc, a. Nombres, a. PROGRAMA_Ficha_carac  FROM inasistencia as i inner join  aprendiz as a on i. N_doc= a. N_doc where Area = 'C.Física' and a.PROGRAMA_Ficha_carac = $_REQUEST[PROGRAMA_Ficha_carac] and i. Trimestre = 'VIII'";
...
<head>
    <title>REGISTROS C.FÍSICA</title>
...
<body>
  <br>
  <br>
   <h1 style="margin-top: 30px;" align="center">REGISTROS DE C.FÍSICA VIII</h1>
   <div id="divContenido2">
        <table  id="tabla13" class="table" width="89%" border="2" align="center">
    <thead style="color: white"> 
   <th>Codigo</th><th>ID_Apre</th><th>Nom_Apre</th><th>Fecha</th><th>Ficha</th><th>Observaciones
   </th><th>Área</th><th>Trimestre</th><th>PDF</th><th>Eliminar</th>
  </thead>
  <tbody>
  <?php
  ...
  <tr bgcolor="#CCCCCC"> 
        ...
        <?php $color = $inasistencia->Observaciones;
          ...
          <td><a style="text-decoration: none; " href='PDFAsistenciaFisica.php?PROGRAMA_Ficha_carac=<?php echo $inasistencia->PROGRAMA_Ficha_carac?>'><p class="fas fa-colorpdf fa-download  "></p>Descargar PDF</a></td>
