...
<h1 style="margin-top: 70px;" align="center">REGISTRAR ASISTENCIA C.FÍSICA VIII</h1>
<div id="divContenido2">
        <table  id="tabla9" class="table" width="89%" border="2" align="center">
...
<tbody>
  ...
  <tr bgcolor="#CCCCCC">
        ...
        <td><?php  echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VIII" ?></td>
            ...
            <td align="center"><a href="frmAgregarInasistenciaFisicaVIII.php?N_doc=<?php echo $aprendiz->N_doc?>"><p class="fas fa-color fa-calendar-check fa-1x"></p>  </a></td>
             <td align="center"><a href="frmAgregarInasistenciaFisicaCon.php?N_doc=<?php echo $aprendiz->N_doc?>"><p class="fas fa-color fa-calendar-check fa-1x"></p>  </a></td>
