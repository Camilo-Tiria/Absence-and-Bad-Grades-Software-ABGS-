...
<table width="89%" border="0" align="center">
  ...
  <tr bgcolor="#CCCCCC">
        ...
        <td align="center"><a href="EditarInstructor.php?Num_doc=<?php echo $instructor->Num_doc?>"><img src="../Imagenes/editar.jpg" width="29" height="24" /></a></td>
        
        <td align="center"><a href="eliminarInstructor.php?Num_doc=<?php echo $instructor->Num_doc?>"><img src="../Imagenes/eliminar.png" 
