...
<body><br>
<form style="margin-top: 80px;" id="form1" name="form1" method="post" action="ModificarR_ACFisica.php">
    ...
    <input title="Nom_Res"  required name="Nom_Res" maxlenght="120" type="text" id="Nom_Res" value="<?php echo $Nom_Res;?>"size="40" /></td></td><tr>
