...
<h1 style="margin-top: 60px;" align="center">ASISTENCIA DE INGLÉS II</h1>
...
<tbody>
  ...
  <tr bgcolor="#CCCCCC">
        ...
        <td><?php  echo $aprendiz->Apellidos  ?></td>
            <td align="center"><a href="listaInglesReporteII.php?N_doc=<?php echo $aprendiz->N_doc?>"><p class="fas fa-color fa-calendar-check fa-1x"></p>  </a></td>
