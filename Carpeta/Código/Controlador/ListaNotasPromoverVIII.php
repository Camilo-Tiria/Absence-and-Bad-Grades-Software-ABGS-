...
<h1 style="margin-top: 60px;" align="center">NOTAS DE PROMOVER VIII</h1>
<div id="divContenido2">
<table  id="tabla8" width="100%" class="table" border="2" align="center">
  <thead style="color: white;"> 
  <th>N_doc</th><th>Nombres</th><th>Apellidos</th><th>Ficha</th><th>Área</th><th>Trimestre</th><th>Marcar</th>
...
<tbody>
  ...
  <tr bgcolor="#CCCCCC">
        ...
        <td><?php  echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VIII" ?></td>
         <td align="center"><a href="frmAgregarNotaPromoverVIII.php?N_doc=<?php echo $aprendiz->N_doc?>"><p class="fas fa-color fa-calendar-check fa-1x"></p>  </a></td>
