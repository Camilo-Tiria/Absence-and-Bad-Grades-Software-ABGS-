...
.bto {
  ...
  background-color:#E1E8EA;
        ...
        <section class="info_items">
                <p><i style="margin-right: 5%;" class="fa fa-envelope fa-2x"></i>abgscompany@gmail.com</p>
                <p><span style="margin-left: -0.5%" class="fas fa-mobile-alt"></span> 320-447-3192 - 313-710-3188</p>
        </section>
        </section>
                <form class="form_contact"action="mailto:abgscompany@gmail.com,catiria4@misena.edu.co, leidy.katherinecc2002@gmail.com " method="post" enctype="text/plain">
        <BR>
...
<button  class="aparte"><a style="text-decoration: none;" href="javascript:history.back()"  ><p style="margin-top:7%" class="fas fa-arrow-left fa-2x"></p></a></button>
</div>
</html>