...
$sql="SELECT  i. Cod_Inas, i. N_doc, i. Fecha_Inas, i. Observaciones,i. Area,i. Trimestre,  a. N_doc, a. Nombres, a. PROGRAMA_Ficha_carac  FROM inasistencia as i inner join  aprendiz as a on i. N_doc= a. N_doc where Area = 'Promover' and a.PROGRAMA_Ficha_carac = $_REQUEST[PROGRAMA_Ficha_carac] and i. Trimestre = 'III'";
...
<body>
  <br>
  <br>
   <h1 style="margin-top: 30px;" align="center">REGISTROS PROMOVER III</h1>
  ...
  <tr bgcolor="#CCCCCC"> 
      ...
      <?php $color = $inasistencia->Observaciones;
          ...
          <td><a style="text-decoration: none; " href='PDFAsistenciaPromover.php?PROGRAMA_Ficha_carac=<?php echo $inasistencia->PROGRAMA_Ficha_carac?>'><p class="fas fa-colorpdf fa-download  "></p>Descargar PDF</a></td>
