...
$sql="SELECT a. N_doc, a. PROGRAMA_Ficha_carac, a. Nombres, a. Apellidos, p. Ficha_carac, p. Trimestres from aprendiz as a Inner join programa as p on a. PROGRAMA_Ficha_carac = p. Ficha_carac where p. Ficha_carac = $_REQUEST[Ficha_carac] and Trimestres='6'"  ;
...
<tbody>
  ...
  <tr bgcolor="#CCCCCC"></tr>
    ...
    <div class="card-body">
              ...
              <center><a href="frmAgregarNotaArea4.php?PROGRAMA_Ficha_carac=<?php echo $aprendiz->Ficha_carac?>" class="btn btn-primary">Entrar</a></center></tbody>
              <style type="text/css">
                .row4{
                width:215px ;
                 height:150px ;
    ...
    echo "<script>
                window.location= 'frmAgregarNotaAreaT.php?Ficha_carac=$_REQUEST[Ficha_carac]'
    </script>";
}
  ?> 
