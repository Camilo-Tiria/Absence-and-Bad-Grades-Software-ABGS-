...
<body><br>
<form style="margin-top: 80px;" id="form1" name="form1" method="post" action="ModificarR_AIngles.php">
        ...
        <input title="Code_Res"  readonly="readonly" disabled ="disabled" required name="Code_Res" type="text" id="Code_Res" value="<?php echo $Code_Res;?>"size="40" /></td></td><tr><tr><tr>
