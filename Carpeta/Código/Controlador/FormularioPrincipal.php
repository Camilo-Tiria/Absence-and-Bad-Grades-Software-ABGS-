...
<div>
<span class="completo">
<input type="email" value='@misena.edu.co' name="Correo_SENA" id="Correo_SENA" placeholder="Por ejemplo, Maria03@misena.edu.co" pattern="[A-Za-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{3,}+\.[a-z]{3,}$" size="30" required/>
</span>
</div>
...
<div>
<span class="mitad">
<input ID="txtPassword" type="Password" Class="input" name="usuPassword"  pattern="(?=.*\d)(?=.*[a-záéíóúüñ]).*[A-ZÁÉÍÓÚÜÑ].*"  title="Debe tener al menos una mayúscula, una minúscula y un dígito" placeholder="**********"  size="25"minlength="8" maxlength="16" required/>         
</span>
...
<li class="izquierda">
<label style="margin-left:" class="titulo" for="">Fecha de Nacimiento: </label>
<input  type="date" class="input" name="Fecha_nac" id="Fecha_nac"  style="margin-left:1.3%" title="Fecha de Nacimiento" size="25"minlength="8" maxlength="16" required/> 
</li>
