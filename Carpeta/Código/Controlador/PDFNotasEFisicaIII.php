...
function Header()
{
  ...
  $this->Image('../Imagenes/fondopdf.jpg', 0, 0, 610, 300  );
    ...
    $this->Cell(130,80,'REGISTRO DE NOTAS AREA C.FISICA ',0,0,'C');
...
$pdf->SetTitle("PDF Notas C.Fisica");
