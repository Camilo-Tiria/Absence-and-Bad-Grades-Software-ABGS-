...
<h1 style="margin-top: 60px;" align="center">REGISTROS NOTAS DE PROMOVER II</h1>
    <div id="divContenido">
  ...
  <tr bgcolor="#CCCCCC">
      ...
      case '10' : $color1 = 'rgb(235, 143, 143)' ; break;
            ...
            <td style="background-color:<?php echo $color1 ?>" > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $notas->Nota ?></td>
                    ...
                    <td rowspan="1"><a style="text-decoration: none; " href='PDFNotasPromoverII.php?PROGRAMA_Ficha_carac=<?php echo $notas->PROGRAMA_Ficha_carac?>'><p class="fas fa-colorpdf fa-download  "></p>Descargar PDF</a></td>
