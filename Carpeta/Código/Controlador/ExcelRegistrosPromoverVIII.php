...
$sql="SELECT i. Cod_Inas, i. N_doc, i. Fecha_Inas, i. Observaciones, i. Area, i. Trimestre, i. Instruc_Tecnico, ie. Num_doc, ie. NombresI, a. N_doc, a. Nombres, a. PROGRAMA_Ficha_carac FROM inasistencia as i inner join aprendiz as a on i. N_doc= a. N_doc inner join instructor as ie on ie. Num_doc = i. Instruc_Tecnico and i. Area = 'Promover' and i. Trimestre = 'VIII'where PROGRAMA_Ficha_carac = $_REQUEST[PROGRAMA_Ficha_carac] ";

$resultado = $objConexion->query($sql);

header("Content-Type:   application/vnd.ms-excel; charset=utf-8");
header("Content-Disposition: attachment; filename=RegistrosPromoverVIII.xls");
?>
<table border="1" >
	<caption bgcolor="green">REGISTROS DEL AREA PROMOVER VIII TRIMESTRE</caption>
	<tr>
  ...
  ?>
        ...
        <td><?php  echo utf8_decode($inasistencia->Area)?></td>
