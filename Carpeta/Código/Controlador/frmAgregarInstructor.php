  ...
  <form id="form1" name="form1" method="post" action="AgregarInstructor.php">
      ...
      <tr>
        ...
        <td width="63%"><label for="Num_doc"></label>
          <input name="Num_doc" type="int" id="Num_doc" maxlength="10" size="40" required="" title="Número de identidad del instructor" /></td>
      </tr>
      <tr>
        ...
        <td><label for="NombresI"></label>
          <input title="Nombres del instructor" maxlength="20" required name="NombresI" type="text" id="NombresI" size="40" /></td>
      </tr>
      <tr>
        <td align="right" bgcolor="#EAEAEA">Apellidos</td>
        <td><label for="ApellidosI"></label>
          <input title="Apellidos del instructor" maxlength="29" required name="ApellidosI" type="text" id="ApellidosI" size="40" /></td>
      </tr>
      <tr>
        <td align="right" bgcolor="#EAEAEA">Telefono</td>
        <td><label for="Telefono"></label>
          <input title="Teléfono del instructor" maxlength="10" required name="Telefono" type="int" id="Telefono" size="40" /></td>
      </tr>
<tr>
        <td align="right" bgcolor="#EAEAEA">Dirección</td>
        <td><label for="Direccion"></label>
          <input title="Direccion del instructor" maxlength="20" required name="Direccion" type="int" id="Direccion" size="40" /></td>
      </tr>
      ...
      <td><label for="Correo_corp"></label>
        <input title="Correo SENA del instructor" required name="Correo_corp" type="email" id="Correo_corp" value="<?php echo $Correo_SENA;?>" size="40"placeholder="PaezT@misena.edu.co" pattern="[A-Za-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{3,}+\.[a-z]{2,}$"  /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><label for="EstadoInstructor_idEstadoInstructor"></label>
          ...
          <select title="Estado del aprendiz" required name="EstadoInstructor_idEstadoInstructor" id="EstadoInstructor_idEstadoInstructor" style="width:326px">
