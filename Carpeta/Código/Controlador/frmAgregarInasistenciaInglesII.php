...
<form style="margin-top: 90px;border-radius: 20px" id="form1" name="form1" method="post" action="AgregarInasistencia.php">

    <tr>
        <center><td colspan="2" align="center" bgcolor="GRAY" style="color:white">✬AGREGAR ASISTENCIA INGLÉS✬</td></center>
   <tr>
    <br>
           <tr>
            <tr>
