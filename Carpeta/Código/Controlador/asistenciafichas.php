...
<table width="89%" border="0" align="center">
  ...
  <tr bgcolor="#CCCCCC">
        ...
        <td><?php  echo $programa->Nom_Program ?>     </td>
         ...
         <td align="center"><a href="frmAgregarInasistencia?Ficha_carac=<?php echo $programa->Ficha_carac?>"><img src="../Imagenes/flecha.jpg" width="29" height="24" /></a></td>
    

         <td align="center"><a href="listaAsistencias?Ficha_carac=<?php echo $programa->Ficha_carac?>"><img src="../Imagenes/asistencia.png" width="29" height="24" /></a></td>
    </tr>
