...
<thead style="color: white">
   <th>Ficha</th><th>Programa</th><th>Jornada</th><th>Área</th><th>Formación</th><th>N°Trimestres</th><th>Registrar</th><th>Reporte_general</th><th>Reporte_especifico</th><th>Tipo_faltas</th>
</thead>
<tbody>
  <?php
  ...
  ?>
    ...
    <tr bgcolor="#CCCCCC">
        ...
        <td align="center"><a href="listaAsistenciasEArea.php?Ficha_carac=<?php echo $programa->Ficha_carac?>"><p class="fas fa-color fa-edit fa-1x"></p></a></td>
         <td align="center"><a href="reglamento.php"><p class="fas fa-color fa-edit fa-1x"></p></a></td>
    </tr>
