...
<div id="divContenedor">
    <div id="divMenu">
      <table class="normal" summary="Tabla genérica" width="100%" height="500" border="5" align="center">
        <tr>
          <td align="center"><a href="vistaPrincipalInstructor.php?pg3=frmAgregarInstructor">AGREGAR</a></td>
        </tr>
        <tr>
          <td align="center"><a href="vistaPrincipalInstructor.php?pg3=listarInstructores">LISTAR</a></td>
        </tr>
  <td align="center"><a href="vistaPrincipalInstructor.php?pg3=listarInstructores1">EDITAR</a></td>
        <tr>
        <td align="center"><a href="vistaPrincipalInstructor.php?pg3=frmConsultarInstructor_Id">CONSULTAR</a></td>
        </tr>
        
          <tr>
          <td align="center"><a href="vistaPrincipalInstructor.php?pg3=tablaInstructores">CANTIDAD</a></td>
        </tr>
      </table>
      <div id="divContenido">
      <?php include $pg3.".php"; ?>
