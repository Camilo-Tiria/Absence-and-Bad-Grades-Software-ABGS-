...
<title>EDITAR R_APROMOVER</title>
<body>
...
<body><br>
<form style="margin-top: 80px;" id="form1" name="form1" method="post" action="ModificarR_APromover.php">
    <center><td colspan="2" align="center" bgcolor="GRAY" style="color: white">EDITAR R_APRENDIZAJE</td></center></tr>
    ...
    <input title="Code_Res"  readonly="readonly" disabled ="disabled" required name="Code_Res" type="text" id="Code_Res" value="<?php echo $Code_Res;?>"size="40" /></td></td><tr><tr>

    <td align="right" bgcolor="#EAEAEA">Nombre </td>
    <input type="hidden" name="Code_Res" value="<?php echo $_REQUEST['Code_Res'] ?>">
    <td><label for="Nom_Res"></label>
    <input title="Nom_Res"  required name="Nom_Res" type="text" id="Nom_Res" value="<?php echo $Nom_Res;?>"size="40" /></td></td><tr>

    <td align="right" bgcolor="#EAEAEA">Area:</td>
    <input type="hidden"name="Code_Res" value="<?php echo $_REQUEST['Code_Res'] ?>">
    <td><label for="Area"></label>
    <select title="Area" readonly="readonly" disabled ="disabled" required name="Area" id="Area" type="enum" size="0" style="width:325px">
        <option value="0">Seleccione</option>
        <option value="Promover">Promover</option>
    </select></td></td><br>

<td class="button" colspan="2" align="center" bgcolor="GRAY"><input type="submit" name="button" id="button" value="Editar" /></td></tr>
</form>
</body>
