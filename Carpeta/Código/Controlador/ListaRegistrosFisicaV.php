...
<?php $color = $notas->Nota;
      ...
      case '10' : $color1 = 'rgb(235, 143, 143)' ; break;
           ...
           <td rowspan="1"><a style="text-decoration: none; " href='PDFNotasFisicaV.php?PROGRAMA_Ficha_carac=<?php echo $notas->PROGRAMA_Ficha_carac?>'><p class="fas fa-colorpdf fa-download  "></p>Descargar PDF</a></td>
