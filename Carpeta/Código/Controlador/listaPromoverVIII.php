...
<h1 style="margin-top: 70px;" align="center">ASISTENCIA DE PROMOVER VIII</h1>
    <div id="divContenido2">
     <table id="tabla11" width="100%" class="table" border="2" align="center">
      <thead style="color: white;">
   <th>N_doc</th><th>Ficha</th><th>Area</th><th>Nombres</th><th>Apellidos</th><th>Reporte</th>
  </thead>
<tbody>
  <?php
  ...
  <tr bgcolor="#CCCCCC">
        ...
        <td><?php  echo $aprendiz->Apellidos  ?></td>
            <td align="center"><a href="listaPromoverReporteVIII.php?N_doc=<?php echo $aprendiz->N_doc?>"><p class="fas fa-color4 fa-calendar-check "></p>  </a></td>
  <?php
  }
  ?>
