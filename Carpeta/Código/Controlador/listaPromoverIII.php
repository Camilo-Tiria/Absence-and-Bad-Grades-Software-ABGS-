...
<h1 style="margin-top: 70px;" align="center">ASISTENCIA DE PROMOVER III</h1>
...
<tbody>
  ...
  <tr bgcolor="#CCCCCC">
        ...
        <td><?php  echo $aprendiz->Apellidos  ?></td>
            <td align="center"><a href="listaPromoverReporteIII.php?N_doc=<?php echo $aprendiz->N_doc?>"><p class="fas fa-color4 fa-calendar-check "></p>  </a></td>
  <?php
  }
  ?>
