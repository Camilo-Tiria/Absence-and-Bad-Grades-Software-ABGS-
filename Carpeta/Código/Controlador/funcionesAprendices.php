...
<div id="divContenido">
  ...
  <tr bgcolor="#CCCCCC">
        ...
        <td><center><?php  echo $aprendiz->Tip_doc  ?> </td>
        ...
        <td align="center"><a href="eliminarAprendiz.php?N_doc=<?php echo $aprendiz->N_doc?>" onclick="return confirm('¿Está seguro que desea eliminar al Aprendiz <?php echo  $aprendiz->Nombres?>?');"><p class="fas fa-color3 
        fa-user-times "></p></a></td> 
  <?php
  }
  ?>
</tbody>
...
<!-- JQUERY -->
    ...
    $(document).ready(function () {
            $('#tabla4').DataTable({
                ...
                scrollY: 260,
                lengthMenu: [ [9,15, 25, -1], [9,15, 25, "Todo"] ],
            });
        });
    </script>
</body>
