...
<head>
  ...
  <font color="White" face="Times New Roman" size="6">Registre sus Datos como Instructor</font></center>
...
<body style="background: #353535;
  ...
  <form style="margin-top: 100px; " id="form1" name="form1" method="post" action="AgregarInstructor2.php">
<center>
    <table width="42%" border="3" align="center">
      <tr>
        <td colspan="2" align="center" bgcolor="GRAY" style="color:white ">INSERTAR DATOS</td>
      </tr>
      <tr>
        <td width="42%" align="right" bgcolor="#EAEAEA">Identificacion</td>
      ...
      <tr>
        <td  width="80%" align="right" bgcolor="#EAEAEA">Contrato :</td>
        <td><label  for="E"></label>
          <select required name="TipoInstructor_idTipoInstructor" id="TipoInstructor_idTipoInstructor" size="0" style="width:302px" title="Tipo en el que se encuentra el instructor">
        ...
        <td><label for="Tip_doc"></label>
          <select title="Tipo de documento del instructor" required name="Tip_doc" id="Tip_doc" type="enum" size="0" style="width:302px">
            <option value="0">Seleccione</option>
...
<tr>
      ...
      <tr>
        ...
        <td><label for="EstadoInstructor_idEstadoInstructor"></label>
          ...
          <select title="Estado del aprendiz" required name="EstadoInstructor_idEstadoInstructor" id="EstadoInstructor_idEstadoInstructor" style="width:302px">
            <option value="0">Seleccione</option>
