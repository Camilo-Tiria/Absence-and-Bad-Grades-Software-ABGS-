...
<h1 style="margin-top: 70px;" align="center">REGISTRAR ASISTENCIA C.FÍSICA II</h1>
...
<tbody>
  ...
  <tr bgcolor="#CCCCCC">
        ...
        <td><?php  echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;II" ?></td>
            ...
            <td align="center"><a href="frmAgregarInasistenciaFisicaII.php?N_doc=<?php echo $aprendiz->N_doc?>"><p class="fas fa-color fa-calendar-check fa-1x"></p>  </a></td>
